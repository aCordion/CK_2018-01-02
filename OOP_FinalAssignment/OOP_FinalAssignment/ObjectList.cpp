...
void CObjectList::insert(int pos, Objects *obj)
{
...
Objects * CObjectList::getObject(int pos)
{
	node *retNode = m_head;
...
void CObjectList::pushFront(Objects *obj)
{
	insert(0, obj);
}

void CObjectList::pushTail(Objects *obj)
{
	node * inNode = new node;
	inNode->object = obj;
	inNode->next = nullptr;
